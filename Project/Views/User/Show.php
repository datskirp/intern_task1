        ...
        <div class="text-left border-2 rounded px-4 py-4">
                <div class="mb-4">
                    ...
                    <input class="shadow appearance-none border rounded w-full
                           ...
                           id="id" name="id" type="text" value="<?= $user['id'] ?>" readonly="readonly">
                </div>
                <div class="mb-4">
                    ...
                    <input class="shadow appearance-none border rounded w-full
                                  py-2 px-3 text-gray-700 leading-tight focus:outline-none
                                  focus:shadow-outline"
                           id="email" name="email" type="text" value="<?= $user['email'] ?>" readonly="readonly">
                ...
                <div class="mb-4">
                    ...
                    <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700
                           ...
                           id="name" name="name" value="<?= $user['name'] ?>" readonly="readonly">
                ...
                <div class="flex flex-row justify-center">
                    ...
                    <button name="delete" class="bg-red-400 hover:border-red-900 text-white font-bold py-2 w-44 border-2 rounded"
                            id="<?= $user['id'] ?>" onclick="deleteUser(this)">Delete</button>
                </div>
        </div>
    </div>
</div>
